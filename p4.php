...
<form action="" method="post">
    <label for="numero">Ingrese el primer numero:</label><br>
    <input type="text" id="numero" name="numero"><br>
    <label for="numero">Ingrese el segundo numero:</label><br>
    <input type="text" id="numero2" name="numero2"><br>
    <label for="numero">Ingrese el tercer numero:</label><br>
...
<?php
    if (isset($_POST['numero'])) {
        ...
        if ($numero>$numero2 && $numero3) {
            if ($numero2>$numero3) {
                echo "<p>El numero mayor es num1: $numero</p>";
                echo "<p>El numero del medio es num2: $numero2</p>";
                echo "<p>El numero menor es num3: $numero3</p>";
            }elseif ($numero2<$numero3){
                echo "<p>El numero mayor es num1: $numero</p>";
                echo "<p>El numero del medio es num3: $numero3</p>";
                echo "<p>El numero menor es num2: $numero2</p>";
            }
        } elseif ($numero<$numero2 && $numero3) {
            if ($numero2>$numero3) {
                echo "<p>El numero mayor es num2: $numero2</p>";
                echo "<p>El numero del medio es num3: $numero3</p>";
                echo "<p>El numero menor es num1: $numero</p>";
            }elseif ($numero2<$numero3){
                echo "<p>El numero mayor es num3: $numero3</p>";
                echo "<p>El numero del medio es num2: $numero2</p>";
                echo "<p>El numero menor es num1: $numero</p>";
            }
        } else {
