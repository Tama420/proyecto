...
<form action="" method="post">
    <label for="numero">Ingrese el nombre del plato que desa:</label><br>
...
<?php
    if (isset($_POST['numero'])) {
        $numero = $_POST['numero'];
        if ($numero = "Espagueti") {
            echo "<p>Plato elejido: $numero</p>";
            echo "<p>Precio:10000</p>";
        } elseif ($numero = "Pasta") {
            echo "<p>Plato elejido: $numero</p>";
            echo "<p>Precio:12000</p>";
        } elseif ($numero = "BandejaPaisa"){
            echo "<p>Plato elejido: $numero</p>";
            echo "<p>Precio:15000</p>";
        } else {
            echo "<p>No se elejio ningun plato</p>";
        }
    }
?>
