...
<head>
    ...
    <title>Juegos y programas en PHP</title>
...
<body>
    <ul class="animenu__nav">
        <li><a href="index.html">Devolverse</a></li>
    </ul>
    <style>
        body {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($numeroUsuario == $numeroAleatorio) {
            echo "<p style='color: green;'>¡Felicidades! Has adivinado el número.</p>";
            $adivinado = true;
    ...
    <form method="post">
        ...
        <input type="number" id="numeroUsuario" name="numeroUsuario">
        <input type="submit" value="Comprobar">
    </form>

    <hr>

    <h2>Algoritmo para detectar el color rojo</h2>
    <?php
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $color = $_POST["color"];
        if ($color === 'rojo') {
            echo "<p style='color: red;'>Finalizado.</p>";
        } else {
            echo "<p>El color ingresado es: $color</p>";
        }
    }
    ?>
    <form method="post">
        <label for="color">Ingrese un color (Escriba 'rojo' para finalizar):</label>
    ...
    <h2>Tabla de multiplicar de un número</h2>
    <?php
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $numero = $_POST["numero"];
    ...
    ?>
    <form method="post">
        <label for="numero">Ingrese un número para ver su tabla de multiplicar:</label>
