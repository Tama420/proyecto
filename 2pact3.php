...
<body>
  ...
  <form action="AreaCRTC.php" method="post">
...
if (isset($_GET['figura']) && isset($_GET['ladoA']) && isset($_GET['ladoB']) && isset($_GET['radio'])) {
    $figura = $_GET['figura'];
    $ladoA = $_GET['ladoA'];
    $ladoB = $_GET['ladoB'];
    $radio = $_GET['radio'];
    ...
    switch ($figura) {
        case 'cuadrado':
            $area = calcularAreaCuadrado($ladoA);
            break;
        case 'rectangulo':
            $area = calcularAreaRectangulo($ladoA, $ladoB);
            break;
        case 'triangulo':
            $area = calcularAreaTriangulo($ladoA, $ladoB);
            break;
        case 'circulo':
    ...
    echo "El area de la figura $figura es: $area";
} else {
